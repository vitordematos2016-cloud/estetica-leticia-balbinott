...
const REST_SHADOW = '0 10px 22px -14px rgba(91,64,51,0.18)';
const ACTIVE_SHADOW = '0 26px 58px -18px rgba(177,138,85,0.45)';
const REST_BORDER = 'rgba(177,138,85,0.22)';
const ACTIVE_BORDER = 'rgba(177,138,85,0.65)';
