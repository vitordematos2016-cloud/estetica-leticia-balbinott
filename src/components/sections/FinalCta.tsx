...
function DecorativeSeal({ animate }: { animate: boolean }) {
  return (
    <div aria-hidden="true" className="relative mx-auto hidden aspect-square w-full max-w-[15rem] lg:block">
      <div className="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_50%_50%,rgba(201,160,109,0.28),transparent_72%)] blur-2xl" />
      ...
      <div className="absolute inset-[5.25rem] rounded-full bg-gradient-to-br from-cream-light to-beige/50 shadow-[inset_0_2px_10px_rgba(91,64,51,0.12)]" />
      <motion.span
      ...
      <Container>
        <Reveal active={hasBeenSeen} direction="up" amount={0.3}>
          <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[2.5rem] border border-gold/30 bg-gradient-to-br from-cream via-cream-light to-beige/40 px-6 py-10 shadow-warm sm:px-12 sm:py-14 lg:px-10 lg:py-16 xl:px-16">
            <div
              aria-hidden="true"
              className="pointer-events-none absolute inset-x-0 top-0 h-40 bg-[radial-gradient(circle_at_50%_0%,rgba(177,138,85,0.14),transparent_70%)]"
            />
            ...
            >
              ...
              <defs>
                <linearGradient id="final-cta-gold-line" x1="0" y1="0" x2="200" y2="200">
                  <stop offset="0%" stopColor="#b18a55" stopOpacity="0" />
                  <stop offset="50%" stopColor="#c9a06d" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#b18a55" stopOpacity="0" />
                </linearGradient>
              </defs>
            </svg>
              ...
              <div className="flex flex-col items-center gap-5 text-center sm:gap-6 lg:items-start lg:text-left">
                ...
                <div className="mt-2 flex w-full flex-col gap-4 sm:w-auto sm:flex-row">
                  <Button
                    ...
                    variant="primary"
                    shine
                    className="border border-gold-deep/30 bg-gradient-to-b from-gold-soft to-gold text-brown-dark shadow-[0_10px_30px_-10px_rgba(177,138,85,0.55)] transition-shadow duration-300 hover:shadow-[0_16px_40px_-12px_rgba(177,138,85,0.7)]"
                  >
