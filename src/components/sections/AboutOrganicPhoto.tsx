    ...
    <div className="flex w-full min-w-0 justify-center overflow-hidden">
      <div className="relative isolate w-[min(calc(100vw-36px),380px)] max-w-full max-[360px]:w-[calc(100vw-28px)] md:w-[min(62vw,450px)] lg:mx-0 lg:w-[clamp(390px,42vw,500px)] xl:w-[clamp(420px,39vw,550px)]">
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(circle, rgba(217,198,174,0.32) 0%, rgba(217,198,174,0) 72%)',
          }}
        />
        ...
        >
          <defs>
            ...
            <filter id={shadowFilterId} x="-30%" y="-30%" width="160%" height="160%">
              <feDropShadow dx="0" dy="5" stdDeviation="7" floodColor="#5b4033" floodOpacity="0.14" />
            </filter>
            <linearGradient id={glintGradientId} x1="0" y1="0" x2="1" y2="1">
              <stop offset="0%" stopColor="#9f7a4c" stopOpacity="0.35" />
              <stop offset="45%" stopColor="#d5b37d" stopOpacity="0.7" />
              <stop offset="52%" stopColor="#fff5dc" stopOpacity="1" />
              <stop offset="59%" stopColor="#d5b37d" stopOpacity="0.7" />
              <stop offset="100%" stopColor="#9f7a4c" stopOpacity="0.35" />
            </linearGradient>
          </defs>
          ...
          <path d={FRAME_PATH} fill="none" stroke="#fffdf9" strokeWidth={5} opacity={0.35} />
          <path d={FRAME_PATH} fill="none" stroke="#b18a55" strokeWidth={2.4} />
          ...
          <motion.path
            ...
            style={{ filter: 'drop-shadow(0 0 5px rgba(202,164,105,0.35))' }}
