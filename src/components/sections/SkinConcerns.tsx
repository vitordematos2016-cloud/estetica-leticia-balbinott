...
import type { SkinConcern } from '../../types/siteContent';
    ...
    <RevealItem>
      ...
      >
        ...
        >
          ...
          <span className="relative text-lg font-medium text-brown-dark transition-colors duration-300 group-hover:text-gold group-active:text-gold group-data-[mobile-active=true]:text-gold">
            {concern.label}
          </span>
