 ...
 * LB + nome) e na base ("Ver mais detalhes"), quase transparente no meio,
 * onde a descrição já tem sombra de texto própria para legibilidade.
 */
const COVER_GRADIENT =
  'linear-gradient(180deg, rgba(255,253,249,0.55) 0%, rgba(255,253,249,0.32) 20%, rgba(241,232,220,0.16) 42%, rgba(241,232,220,0.14) 58%, rgba(255,253,249,0.32) 80%, rgba(255,253,249,0.58) 100%)';
